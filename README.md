...
5. [ICLR 2023] **Fair Attribute Completion on Graph with Missing Attributes** \[[paper](https://openreview.net/pdf?id=9vcXCMp9VEp)]
6. [ICLR 2023] **Confidence-Based Feature Imputation for Graphs with Partially Known Features** \[[paper](https://openreview.net/pdf?id=YPKBIILy-Kt)]
7. [ICLR 2023] **Learnable Topological Features for Phylogenetic Inference via Graph Neural Networks** \[[paper](https://arxiv.org/pdf/2302.08840.pdf)]
8. [KBS 2023] **Dynamic Graph Convolutional Recurrent Imputation Network for Spatiotemporal Traffic Missing Data** \[[paper](https://www.sciencedirect.com/science/article/abs/pii/S0950705122012849?via%3Dihub)]
9. [WSDM 2023] **S2GAE: Self-Supervised Graph Autoencoders are Generalizable Learners with Graph Masking** \[[paper](https://dl.acm.org/doi/abs/10.1145/3539597.3570404)]
10. [Information Sciences 2023] **Ensembled Masked Graph Autoencoders for Link Anomaly Detection in A Road Network Considering Spatiotemporal Features** \[[paper](https://www.sciencedirect.com/science/article/abs/pii/S0020025522014670)]
11. [Methods 2023] **Multi-sample dual-decoder graph autoencoder** \[[paper](https://www.sciencedirect.com/science/article/abs/pii/S1046202323000257)]
12. [Arxiv 2023.01] **Generative Graph Neural Networks for Link Prediction** \[[paper](https://arxiv.org/pdf/2301.00169.pdf)]
13. [Arxiv 2023.01] **AutoAC: Towards Automated Attribute Completion for Heterogeneous Graph Neural Network** \[[paper](https://arxiv.org/pdf/2301.03049.pdf)]
14. [Arxiv 2023.01] **Who Should I Engage with At What Time? A Missing Event Aware Temporal Graph Neural Network** \[[paper](https://arxiv.org/pdf/2301.08399.pdf)] 
15. [Arxiv 2023.01] **HAT-GAE: Self-Supervised Graph Auto-encoders with Hierarchical Adaptive Masking and Trainable Corruption** \[[paper](https://arxiv.org/pdf/2301.12063.pdf)] 
16. [Arxiv 2023.02] **Revisiting Initializing Then Refining: An Incomplete and Missing Graph Imputation Network** \[[paper](https://arxiv.org/pdf/2302.07524.pdf)] 
17. [Arxiv 2023.02] **Self-supervised Guided Hypergraph Feature Propagation for Semi-supervised Classification with Missing Node Features** \[[paper](https://arxiv.org/pdf/2302.08250.pdf)] 
18. [Arxiv 2023.03] **Uncovering the Missing Pattern: Unified Framework Towards Trajectory Imputation and Prediction** \[[paper](https://arxiv.org/pdf/2303.16005.pdf)] 
19. [Arxiv 2023.04] **RARE: Robust Masked Graph Autoencoder** \[[paper](https://arxiv.org/pdf/2304.01507.pdf)] 
...
17. [PR 2022] **Incomplete Multiview Nonnegative Representation Learning with Multiple Graphs** \[[paper](https://www.sciencedirect.com/science/article/pii/S0031320321005884?casa_token=gw2E5xd2I78AAAAA:K8mBWuiiuB7PptbiBRRmOO0yoEJBttFvjYaHC61caGoKWjyXVq2ggw5WNKoKcvqW3_cVe2S3EQ)]
...
24. [NeurIPS Workshop 2022] **Bi-channel Masked Graph Autoencoders for Spatially Resolved Single-cell Transcriptomics Data Imputation** \[[paper](https://openreview.net/pdf?id=LGFbhnR4U33)]
...
29. [CIKM 2022] **On Positional and Structural Node Features for Graph Neural Networks on Non-attributed Graphs** \[[paper](https://arxiv.org/pdf/2107.01495.pdf)]
30. [EMNLP 2022] **Self-supervised Graph Masking Pre-training for Graph-to-Text Generation** \[[paper](https://arxiv.org/pdf/2210.10599.pdf)] 
31. [COLING 2022] **The Effectiveness of Masked Language Modeling and Adapters for Factual Knowledge Injection** \[[paper](https://arxiv.org/pdf/2210.00907.pdf)] 
32. [ECML-PKDD 2022] **Masked Graph Auto-Encoder Constrained Graph Pooling** \[[paper](https://2022.ecmlpkdd.org/wp-content/uploads/2022/09/sub_542.pdf)]
33. [Arxiv 2022.01] **MGAE: Masked Autoencoders for Self-Supervised Learning on Graphs** \[[paper](https://arxiv.org/pdf/2201.02534)]
34. [Arxiv 2022.02] **Graph Masked Autoencoders with Transformers** \[[paper](https://arxiv.org/pdf/2202.08391.pdf)]
35. [Arxiv 2022.03] **Multilingual Knowledge Graph Completion with Self-Supervised Adaptive Graph Alignment** \[[paper](https://arxiv.org/pdf/2203.14987.pdf)]
36. [Arxiv 2022.03] **ACTIVE: Augmentation-Free Graph Contrastive Learning for Partial Multi-View Clustering** \[[paper](https://arxiv.org/pdf/2203.00186.pdf)]
37. [Arxiv 2022.03] **Gransformer: Transformer-based Graph Generation** \[[paper](https://arxiv.org/pdf/2203.13655.pdf)]
38. [Arxiv 2022.04] **Graph Auto-Encoders for Network Completion** \[[paper](https://arxiv.org/pdf/2204.11852.pdf)]
39. [Arxiv 2022.05] **MaskGAE: Masked Graph Modeling Meets Graph Autoencoders** \[[paper](https://arxiv.org/pdf/2205.10053.pdf)]
40. [Arxiv 2022.05] **Robust Graph Representation Learning for Local Corruption Recovery** \[[paper](https://arxiv.org/pdf/2202.04936.pdf)]
41. [Arxiv 2022.05] **Learning to Reconstruct Missing Data from Spatiotemporal Graphs with Sparse Observations** \[[paper](https://arxiv.org/pdf/2205.13479.pdf)]
42. [Arxiv 2022.06] **Accurate Node Feature Estimation with Structured Variational Graph Autoencoder** \[[paper](https://arxiv.org/pdf/2206.04516.pdf)]
43. [Arxiv 2022.06] **ExpressivE: A Spatio-Functional Embedding For Knowledge Graph Completion** \[[paper](https://arxiv.org/pdf/2206.04192.pdf)]
44. [Arxiv 2022.06] **Schema-Guided Event Graph Completion** \[[paper](https://arxiv.org/pdf/2206.02921.pdf)]
45. [Arxiv 2022.06] **Attention-wise Masked Graph Contrastive Learning for Predicting Molecular Property** \[[paper](https://arxiv.org/pdf/2206.08262.pdf)]
46. [Arxiv 2022.07] **Unsupervised pre-training of graph transformers on patient population graphs** \[[paper](https://arxiv.org/pdf/2207.10603.pdf)]
47. [Arxiv 2022.07] **Masked Spatial-Spectral Autoencoders Are Excellent Hyperspectral Defenders** \[[paper](https://arxiv.org/pdf/2207.07803.pdf)]
48. [Arxiv 2022.07] **Cybersecurity Entity Alignment via Masked Graph Attention Networks** \[[paper](https://arxiv.org/pdf/2207.01434.pdf)]
49. [Arxiv 2022.08] **Heterogeneous Graph Masked Autoencoders** \[[paper](https://arxiv.org/pdf/2208.09957.pdf)]
50. [Arxiv 2022.08] **Revisiting Item Promotion in GNN-based Collaborative Filtering: A Masked Targeted Topological Attack Perspectiv** \[[paper](https://arxiv.org/pdf/2208.09979.pdf)]
51. [Arxiv 2022.09] **DiP-GNN: Discriminative Pre-Training of Graph Neural Networks** \[[paper](https://arxiv.org/pdf/2209.07499.pdf)]
52. [Arxiv 2022.10] **Federated Graph-based Networks with Shared Embedding** \[[paper](https://arxiv.org/pdf/2210.01803.pdf)]
53. [Arxiv 2022.10] **How Mask Matters: Towards Theoretical Understandings of Masked Autoencoders** \[[paper](https://arxiv.org/pdf/2210.08344.pdf)]
54. [Arxiv 2022.10] **M3FGM: A Node Masking and Multi-granularity Message Passing-based Federated Graph Model for Spatial-temporal Data Prediction** \[[paper](https://arxiv.org/ftp/arxiv/papers/2210/2210.16193.pdf)]
55. [Arxiv 2022.11] **BatmanNet: Bi-branch Masked Graph Transformer Autoencoder for Molecular Representation** \[[paper](https://arxiv.org/pdf/2211.13979.pdf)]
56. [Arxiv 2022.11] **Handling Missing Data via Max-Entropy Regularized Graph Autoencoder** \[[paper](https://arxiv.org/pdf/2211.16771.pdf)]
57. [Arxiv 2022.12] **Variational Reasoning over Incomplete Knowledge Graphs for Conversational Recommendation** \[[paper](https://arxiv.org/pdf/2212.11868.pdf)]
58. [Arxiv 2022.12] **Csat: Contrastive Sampling-Aggregating Transformer for Attribute-Missing Graph Learning** \[[paper](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4278482)]
