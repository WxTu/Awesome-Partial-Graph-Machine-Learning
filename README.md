...
20. [NeurIPS 2022] **Neural-Symbolic Entangled Framework for Complex Query Answering** \[[paper](https://arxiv.org/pdf/2209.08779.pdf)]
21. [NeurIPS 2022] **Rethinking Knowledge Graph Evaluation Under the Open-World Assumption** \[[paper](https://arxiv.org/pdf/2209.08858.pdf)]
22. [NeurIPS 2022] **Deep Bidirectional Language-Knowledge Graph Pretraining** \[[paper](https://arxiv.org/pdf/2210.09338.pdf)]
23. [NeurIPS Workshop 2022] **Bi-channel Masked Graph Autoencoders for Spatially Resolved Single-cell Transcriptomics Data Imputation** \[[paper](https://openreview.net/pdf?id=LGFbhnR4U33)]
24. [CIKM 2022] **I Know What You Do Not Know: Knowledge Graph Embedding via Co-distillation Learning** \[[paper](https://arxiv.org/pdf/2208.09828.pdf)]
25. [CIKM 2022] **Models and Benchmarks for Representation Learning of Partially Observed Subgraphs** \[[paper](https://arxiv.org/pdf/2209.00508.pdf)]
26. [CIKM 2022] **MGMAE: Molecular Representation Learning by Reconstructing Heterogeneous Graphs with A High Mask Ratio** \[[paper](https://arxiv.org/pdf/2208.09905.pdf)]
27. [CIKM 2022] **MentorGNN: Deriving Curriculum for Pre-Training GNNs** \[[paper](https://arxiv.org/pdf/2209.00508.pdf)]
28. [EMNLP 2022] **Self-supervised Graph Masking Pre-training for Graph-to-Text Generation** \[[paper](https://arxiv.org/pdf/2210.10599.pdf)] 
29. [COLING 2022] **The Effectiveness of Masked Language Modeling and Adapters for Factual Knowledge Injection** \[[paper](https://arxiv.org/pdf/2210.00907.pdf)] 
30. [ECML-PKDD 2022] **Masked Graph Auto-Encoder Constrained Graph Pooling** \[[paper](https://2022.ecmlpkdd.org/wp-content/uploads/2022/09/sub_542.pdf)]
31. [Arxiv 2022.01] **MGAE: Masked Autoencoders for Self-Supervised Learning on Graphs** \[[paper](https://arxiv.org/pdf/2201.02534)]
32. [Arxiv 2022.02] **Graph Masked Autoencoders with Transformers** \[[paper](https://arxiv.org/pdf/2202.08391.pdf)]
33. [Arxiv 2022.03] **Multilingual Knowledge Graph Completion with Self-Supervised Adaptive Graph Alignment** \[[paper](https://arxiv.org/pdf/2203.14987.pdf)]
34. [Arxiv 2022.03] **ACTIVE: Augmentation-Free Graph Contrastive Learning for Partial Multi-View Clustering** \[[paper](https://arxiv.org/pdf/2203.00186.pdf)]
35. [Arxiv 2022.03] **Gransformer: Transformer-based Graph Generation** \[[paper](https://arxiv.org/pdf/2203.13655.pdf)]
36. [Arxiv 2022.04] **Graph Auto-Encoders for Network Completion** \[[paper](https://arxiv.org/pdf/2204.11852.pdf)]
37. [Arxiv 2022.05] **MaskGAE: Masked Graph Modeling Meets Graph Autoencoders** \[[paper](https://arxiv.org/pdf/2205.10053.pdf)]
38. [Arxiv 2022.05] **Robust Graph Representation Learning for Local Corruption Recovery** \[[paper](https://arxiv.org/pdf/2202.04936.pdf)]
39. [Arxiv 2022.05] **Learning to Reconstruct Missing Data from Spatiotemporal Graphs with Sparse Observations** \[[paper](https://arxiv.org/pdf/2205.13479.pdf)]
40. [Arxiv 2022.06] **Accurate Node Feature Estimation with Structured Variational Graph Autoencoder** \[[paper](https://arxiv.org/pdf/2206.04516.pdf)]
41. [Arxiv 2022.06] **ExpressivE: A Spatio-Functional Embedding For Knowledge Graph Completion** \[[paper](https://arxiv.org/pdf/2206.04192.pdf)]
42. [Arxiv 2022.06] **Schema-Guided Event Graph Completion** \[[paper](https://arxiv.org/pdf/2206.02921.pdf)]
43. [Arxiv 2022.06] **Attention-wise Masked Graph Contrastive Learning for Predicting Molecular Property** \[[paper](https://arxiv.org/pdf/2206.08262.pdf)]
44. [Arxiv 2022.07] **Unsupervised pre-training of graph transformers on patient population graphs** \[[paper](https://arxiv.org/pdf/2207.10603.pdf)]
45. [Arxiv 2022.07] **Masked Spatial-Spectral Autoencoders Are Excellent Hyperspectral Defenders** \[[paper](https://arxiv.org/pdf/2207.07803.pdf)]
46. [Arxiv 2022.07] **Cybersecurity Entity Alignment via Masked Graph Attention Networks** \[[paper](https://arxiv.org/pdf/2207.01434.pdf)]
47. [Arxiv 2022.08] **Heterogeneous Graph Masked Autoencoders** \[[paper](https://arxiv.org/pdf/2208.09957.pdf)]
48. [Arxiv 2022.08] **Revisiting Item Promotion in GNN-based Collaborative Filtering: A Masked Targeted Topological Attack Perspectiv** \[[paper](https://arxiv.org/pdf/2208.09979.pdf)]
49. [Arxiv 2022.09] **DiP-GNN: Discriminative Pre-Training of Graph Neural Networks** \[[paper](https://arxiv.org/pdf/2209.07499.pdf)]
50. [Arxiv 2022.10] **Federated Graph-based Networks with Shared Embedding** \[[paper](https://arxiv.org/pdf/2210.01803.pdf)]
51. [Arxiv 2022.10] **How Mask Matters: Towards Theoretical Understandings of Masked Autoencoders** \[[paper](https://arxiv.org/pdf/2210.08344.pdf)]
...
5. [FGCS 2021] **Graph Convolutional Networks for Graphs Containing Missing Features** \[[paper](https://www.sciencedirect.com/science/article/pii/S0167739X20330405)|[code](https://github.com/marblet/GCNmf)]
6. [FGCS 2021] **Efficient Search Over Incomplete Knowledge Graphs in Binarized Embedding Space** \[[paper](https://www-sciencedirect-com-s.nudtproxy.yitlink.com/science/article/pii/S0167739X21001217)]
...
8. [KDD Workshop 2021] **On Positional and Structural Node Features for Graph Neural Networks on Non-attributed Graphs** \[[paper](https://arxiv.org/pdf/2107.01495.pdf)|[code](https://github.com/zjzijielu/gnn-exp)]
...
11. [IEEE TSP 2021] **Community Detection and Matrix Completion With Social and Item Similarity Graphs** \[[paper](https://ieeexplore.ieee.org/document/9328183)|[code](https://github.com/bayrameda/MrAP)]
12. [Nature Communications 2021] **Masked Graph Modeling for Molecule Generation** \[[paper](https://www.nature.com/articles/s41467-021-23415-2)]
13. [Arxiv 2021.02] **Wasserstein Diffusion on Graphs with Missing Attributes** \[[paper](https://arxiv.org/pdf/2102.03450.pdf)]
14. [Arxiv 2021.06] **Incomplete Graph Representation and Learning via Partial Graph Neural Networks** \[[paper](https://arxiv.org/pdf/2003.10130v2.pdf)]
15. [Arxiv 2021.06] **Graph Context Encoder: Graph Feature Inpainting for Graph Generation and Self-supervised Pretraining** \[[paper](https://arxiv.org/pdf/2106.10124.pdf)]
16. [Arxiv 2021.10] **VICAUSE: Simultaneous Missing Value Imputation and Causal Discovery with Groups** \[[paper](https://arxiv.org/pdf/2110.08223.pdf)]
17. [Arxiv 2021.10] **CORGI: Content-Rich Graph Neural Networks with Attention** \[[paper](https://arxiv.org/pdf/2110.04866.pdf)|[code](https://github.com/microsoft/project-azua)]
18. [Arxiv 2021.10] **SMORE: Knowledge Graph Completion and Multi-hop Reasoning in Massive Knowledge Graphs** \[[paper](https://arxiv.org/pdf/2110.14890.pdf)|[code](https://github.com/google-research/smore)]\
19. [Arxiv 2021.11] **On the Unreasonable Effectiveness of Feature propagation in Learning on Graphs with Missing Node Features** \[[paper](https://arxiv.org/pdf/2111.12128.pdf)]
20. [Arxiv 2021.12] **Siamese Attribute-missing Graph Auto-encoder** \[[paper](https://arxiv.org/pdf/2112.04842.pdf)][Arxiv 2021.12] **Link-Intensive Alignment for Incomplete Knowledge Graphs** \[[paper](https://arxiv.org/pdf/2112.09266.pdf)]
21. [Arxiv 2021.12] **Incomplete Multi-view Clustering via Cross-view Relation Transfer** \[[paper](https://arxiv.org/pdf/2112.00739.pdf)]
22. [Arxiv 2021.12] **Two-view Graph Neural Networks for Knowledge Graph Completion** \[[paper](https://arxiv.org/pdf/2112.09231.pdf)]
23. [Arxiv 2021.12] **Incomplete Knowledge Graph Alignment** \[[paper](https://arxiv.org/pdf/2112.09266.pdf)]
