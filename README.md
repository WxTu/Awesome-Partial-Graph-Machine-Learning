...
8. [WWW 2022] **Trustworthy Knowledge Graph Completion Based on Multi-sourced Noisy Data** \[[paper](https://arxiv.org/abs/2201.08580)|[code](https://github.com/nju-websoft/TKGC)]
9. [WWW Workshop 2022] **Analyzing Heterogeneous Networks with Missing Attributes by Unsupervised Contrastive Learning** \[[paper](https://arxiv.org/pdf/2203.02656.pdf)]
10. [PR 2022] **Incomplete Multiview Nonnegative Representation Learning with Multiple Graphs** \[[paper](https://www.sciencedirect.com/science/article/pii/S0031320321005884?casa_token=gw2E5xd2I78AAAAA:K8mBWuiiuB7PptbiBRRmOO0yoEJBttFvjYaHC61caGoKWjyXVq2ggw5WNKoKcvqW3_cVe2S3EQ)]
11. [ICLR 2022] **Cold Brew: Distilling Graph Node Representations with Incomplete or Missing Neighborhoods** \[[paper](https://arxiv.org/pdf/2111.04840.pdf)|[code](https://github.com/amazon-research/gnn-tail-generalization)]
12. [Arxiv 2022] **MGAE: Masked Autoencoders for Self-Supervised Learning on Graphs** \[[paper](https://arxiv.org/pdf/2201.02534)]
13. [Arxiv 2022] **Deep Partial Multiplex Network Embedding** \[[paper](https://arxiv.org/pdf/2203.02656.pdf)]
14. [Arxiv 2022] **Accurate Node Feature Estimation with Structured Variational Graph Autoencoder** \[[paper](https://arxiv.org/pdf/2206.04516.pdf)]
15. [Arxiv 2022] **ExpressivE: A Spatio-Functional Embedding For Knowledge Graph Completion** \[[paper](https://arxiv.org/pdf/2206.04192.pdf)]
16. [Arxiv 2022] **MaskGAE: Masked Graph Modeling Meets Graph Autoencoders** \[[paper](https://arxiv.org/pdf/2205.10053.pdf)]
17. [Arxiv 2022] **Graph Auto-Encoders for Network Completion** \[[paper](https://arxiv.org/pdf/2204.11852.pdf)]
18. [Arxiv 2022] **Multilingual Knowledge Graph Completion with Self-Supervised Adaptive Graph Alignment** \[[paper](https://arxiv.org/pdf/2203.14987.pdf)]
19. [Arxiv 2022] **ACTIVE: Augmentation-Free Graph Contrastive Learning for Partial Multi-View Clustering** \[[paper](https://arxiv.org/pdf/2203.00186.pdf)]
