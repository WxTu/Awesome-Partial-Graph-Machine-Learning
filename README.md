...
6. [KDD 2022] **GraphMAE: Self-Supervised Masked Graph Autoencoders** \[[paper](https://arxiv.org/pdf/2205.10803.pdf)] 
7. [KDD 2022] **Knowledge Graph Completion with Pre-trained Multimodal Transformer and Twins Negative Sampling** \[[paper](https://arxiv.org/pdf/2209.07084.pdf)] 
8. [IJCAI 2022] **Positive-Unlabeled Learning with Adversarial Data Augmentation for Knowledge Graph Completion** \[[paper](https://arxiv.org/pdf/2205.00904.pdf)]
9. [IJCAI 2022] **Initializing Then Refining: A Simple Graph Attribute Imputation Network** \[[paper](https://github.com/WxTu/ITR/blob/master/ITR-final.pdf)]
10. [WWW 2022] **Trustworthy Knowledge Graph Completion Based on Multi-sourced Noisy Data** \[[paper](https://arxiv.org/pdf/2201.08580.pdf)|[code](https://github.com/nju-websoft/TKGC)]
11. [WWW 2022] **From Discrimination to Generation: Knowledge Graph Completion with Generative Transformer** \[[paper](https://arxiv.org/pdf/2202.02113.pdf)]
12. [WWW Workshop 2022] **Deep Partial Multiplex Network Embedding** \[[paper](https://arxiv.org/pdf/2203.02656.pdf)]
13. [SIGIR 2022] **Re-thinking Knowledge Graph Completion Evaluation from an Information Retrieval Perspective** \[[paper](https://arxiv.org/pdf/2205.04105.pdf)]
14. [PR 2022] **Incomplete Multiview Nonnegative Representation Learning with Multiple Graphs** \[[paper](https://www.sciencedirect.com/science/article/pii/S0031320321005884?casa_token=gw2E5xd2I78AAAAA:K8mBWuiiuB7PptbiBRRmOO0yoEJBttFvjYaHC61caGoKWjyXVq2ggw5WNKoKcvqW3_cVe2S3EQ)]
15. [ICLR 2022] **Cold Brew: Distilling Graph Node Representations with Incomplete or Missing Neighborhoods** \[[paper](https://arxiv.org/pdf/2111.04840.pdf)|[code](https://github.com/amazon-research/gnn-tail-generalization)]
16. [ICLR 2022] **Neural Methods for Logical Reasoning Over Knowledge Graphs** \[[paper](https://arxiv.org/pdf/2209.14464.pdf)]
17. [CIKM 2022] **I Know What You Do Not Know: Knowledge Graph Embedding via Co-distillation Learning** \[[paper](https://arxiv.org/pdf/2208.09828.pdf)]
18. [CIKM 2022] **Improving Knowledge-aware Recommendation with Multi-level Interactive Contrastive Learning** \[[paper](https://arxiv.org/pdf/2208.10061.pdf)]
19. [CIKM 2022] **Models and Benchmarks for Representation Learning of Partially Observed Subgraphs** \[[paper](https://arxiv.org/pdf/2209.00508.pdf)]
20. [Arxiv 2022.01] **MGAE: Masked Autoencoders for Self-Supervised Learning on Graphs** \[[paper](https://arxiv.org/pdf/2201.02534)]
21. [Arxiv 2022.02] **Graph Masked Autoencoders with Transformers** \[[paper](https://arxiv.org/pdf/2202.08391.pdf)]
22. [Arxiv 2022.03] **Multilingual Knowledge Graph Completion with Self-Supervised Adaptive Graph Alignment** \[[paper](https://arxiv.org/pdf/2203.14987.pdf)]
23. [Arxiv 2022.03] **ACTIVE: Augmentation-Free Graph Contrastive Learning for Partial Multi-View Clustering** \[[paper](https://arxiv.org/pdf/2203.00186.pdf)]
24. [Arxiv 2022.04] **Graph Auto-Encoders for Network Completion** \[[paper](https://arxiv.org/pdf/2204.11852.pdf)]
25. [Arxiv 2022.05] **MaskGAE: Masked Graph Modeling Meets Graph Autoencoders** \[[paper](https://arxiv.org/pdf/2205.10053.pdf)]
26. [Arxiv 2022.05] **Learning to Reconstruct Missing Data from Spatiotemporal Graphs with Sparse Observations** \[[paper](https://arxiv.org/pdf/2205.13479.pdf)]
27. [Arxiv 2022.06] **Accurate Node Feature Estimation with Structured Variational Graph Autoencoder** \[[paper](https://arxiv.org/pdf/2206.04516.pdf)]
28. [Arxiv 2022.06] **ExpressivE: A Spatio-Functional Embedding For Knowledge Graph Completion** \[[paper](https://arxiv.org/pdf/2206.04192.pdf)]
29. [Arxiv 2022.06] **Schema-Guided Event Graph Completion** \[[paper](https://arxiv.org/pdf/2206.02921.pdf)]
